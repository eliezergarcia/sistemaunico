            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive-sm">
                        <table id="clients-datatable" class="table table-centered table-striped table-hover table-striped table-striped dt-responsive nowrap w-100 dataTable no-footer dtr-inline">
                            <thead>
                                <tr>
                                    <th width="4%">#</th>
                                    <th>Código</th>
