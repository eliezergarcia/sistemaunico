...
@section('title', 'Adminsitración | Conceptos de proveedor')
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Conceptos de proveedor</li>
                    </ol>
                </div>
                <h4 class="page-title">Conceptos de proveedor</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('conceptosproveedor.store') }}" enctype="multipart/form-data" class="pl-2 pr-2">
                        {!! csrf_field() !!}
                        <div class="row">
                             <div class="col-12">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label>Rate</label>
                                    <input type="number" step="any" class="form-control form-control-light{{ $errors->has('rate') ? ' is-invalid' : '' }}" name="rate" value="0">
                                    @if ($errors->has('rate'))
                                        <span class="invalid-feedback" role="alert">
    ...
    <div id="information-concept-modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="information-concept-form" method="POST" action="{{ route('conceptosproveedor.update') }}" enctype="multipart/form-data" class="pl-2 pr-2">
                        {!! csrf_field() !!}
            ...
            <div class="modal-content">
                <div class="modal-body p-4">
                    <div class="text-center">
                        ...
                        <form id="activate_concept_form" style="display: inline;" action="{{ route('conceptosproveedor.activate') }}" method="POST">
                            {!! csrf_field() !!}
                            {{-- {!! method_field('PATCH') !!} --}}
                            <input type="hidden" name="concept_id">
            ...
            <div class="modal-content">
                <div class="modal-body p-4">
                    <div class="text-center">
                        ...
                        <button type="button" class="btn btn-light my-2" data-dismiss="modal">Cancelar</button>
                        <form id="deactivate_concept_form" style="display: inline;" action="{{ route('conceptosproveedor.deactivate') }}" method="POST">
                            {!! csrf_field() !!}
                            {!! method_field('DELETE') !!}
                            <input type="hidden" name="concept_id">
...
@section('scripts')
    ...
    <script>
        ...
        function information_concept_modal($id){
            var url = '/conceptosproveedor/buscar/' + $id;
