                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="float-left mt-3">
                                                    <p><b>Remision</b></p>
                                                    <p class="font-13">
                                                        Eliezer Neftalí Hernández García<br>
                                                        RFC: HEGE950731GG1<br>
                                                        El Sabinal #730<br>
                                                        Col. Terranova Residencial, C.P 67267<br>
                                                        Juárez, Nuevo León<br>
                                                        Tel: (52) 8129368475<br>
                                                    </p>
                                                </div>
                                            ...
                                            <div class="col-sm-4 offset-sm-2">
                                                <div class="mt-3 float-sm-right">
                                                    <p class="font-13"><strong>Fecha: </strong> &nbsp;&nbsp;&nbsp; Septiembre 06, 2019</p>
                                                </div>
                                            </div><!-- end col -->
                                        </div>
                                        <!-- end row -->
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-sm-4">
                                                <p><b>Receptor</b></p>
                                                <p class="font-13">
                                                    UNICO LOGISTICS MEX S DE RL DE CV<br>
                                                    RFC: ULM1509029A1<br>
                                                    Carr. Miguel Alemán No, 804, L2<br>
                                                    Col. Haciendo las Fuentes, C.P. 66477,<br>
                                                    San Nicolás de los Garza Nl.<br>
                                                    Tel:(52) 81-10909472/ (52) 81-10908987<br>
                                                </p>
                                            </div> <!-- end col-->
                                        </div>
                                        <!-- end row -->
                                                    ...
                                                    <table class="table mt-4">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>1</td>
                                                                <td>
                                                                    <b>ANTICIPO DESARROLLO DE OTHER INVOICES</b> <br/>
                                                                </td>
                                                                <td class="float-right">$ 1400.00</td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="float-right mt-3 mt-sm-0">
                                                    <p><b>Sub-total:</b> <span class="float-right">$ 1400.00</span></p>
                                                    <p><b>Iva-total:</b> <span class="float-right">$ 224.00</span></p>
                                                    <h3>TOTAL: $ 1624.00 MXN</h3>
