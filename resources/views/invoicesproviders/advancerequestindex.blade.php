...
@section('title', 'Sistema | Solicitudes de anticipo')
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Solicitudes de anticipo</li>
                    </ol>
                </div>
                <h4 class="page-title">Solicitudes de anticipo</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
        ...
        function search_accounts($account_id)
        {
            ...
            axios.get('/proveedores/buscarcuentas', {
                ...
                for(var i=0;i<=response.data.accounts.length;i++){
                    if ($account_id == response.data.accounts[i].id) {
