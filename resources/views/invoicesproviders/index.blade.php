                            ...
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="any" class="form-control form-control-light{{ $errors->has('neto') ? ' is-invalid' : '' }}" name="neto" value="0">
                                        @if ($errors->has('neto'))
                                            <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        <label>Vat</label>
                                        <input type="number" step="any" class="form-control form-control-light{{ $errors->has('vat') ? ' is-invalid' : '' }}" name="vat" value="0">
                                        @if ($errors->has('vat'))
                                            <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="any" class="form-control form-control-light{{ $errors->has('retention') ? ' is-invalid' : '' }}" name="retention" value="0">
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        <label>Others</label>
                                        <input type="number" step="any" class="form-control form-control-light{{ $errors->has('others') ? ' is-invalid' : '' }}" name="others" value="0">
                        ...
                        <form id="information-invoice-form" method="POST" action="{{ route('facturasproveedor.modificar') }}" enctype="multipart/form-data" class="pl-2 pr-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        <label>Neto <span class="text-danger">*</span></label>
                                        <input type="number" step="any" class="form-control form-control-light{{ $errors->has('neto') ? ' is-invalid' : '' }}" name="neto">
                                        @if ($errors->has('neto'))
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $errors->first('neto') }}</strong>
                                            </span>
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="any" class="form-control form-control-light{{ $errors->has('vat') ? ' is-invalid' : '' }}" name="vat">
                                        @if ($errors->has('vat'))
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $errors->first('vat') }}</strong>
                                            </span>
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="any" class="form-control form-control-light{{ $errors->has('retention') ? ' is-invalid' : '' }}" name="retention">
                                        @if ($errors->has('retention'))
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $errors->first('retention') }}</strong>
                                            </span>
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="any" class="form-control form-control-light{{ $errors->has('others') ? ' is-invalid' : '' }}" name="others">
                                        @if ($errors->has('others'))
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $errors->first('others') }}</strong>
                                            </span>
