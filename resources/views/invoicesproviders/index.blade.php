...
@section('title', 'Sistema | Facturas de proveedores')
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Facturas de proveedores</li>
                    </ol>
                </div>
                <h4 class="page-title">Facturas de proveedores</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                                        ...
                                        <td>
                                            ...
                                            @if(!$invoice->canceled_at)
                                                @if((Auth::user()->present()->isAdmin() && Auth::user()->present()->isOper()) || Auth::user()->present()->isAdminGeneral() || Auth::user()->present()->isFin())
                                                    <a href="{{ route('facturasproveedor.show', $invoice->id )}}" class="action-icon btn btn-link" data-toggle="tooltip" data-placement="top" title data-original-title="Ver información"> <i class="mdi mdi-eye"></i></a>
                                                    @if(!$invoice->aut_oper)
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="{{ route('facturasproveedor.store') }}" enctype="multipart/form-data" class="pl-2 pr-2">
                            {!! csrf_field() !!}
                            <div class="row">
                                 <div class="col-7">
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="any" class="form-control {{ $errors->has('neto') ? ' is-invalid' : '' }}" name="neto" value="0">
                                        @if ($errors->has('neto'))
                                            <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        <label>Vat</label>
                                        <input type="number" step="any" class="form-control {{ $errors->has('vat') ? ' is-invalid' : '' }}" name="vat" value="0">
                                        @if ($errors->has('vat'))
                                            <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="any" class="form-control {{ $errors->has('retention') ? ' is-invalid' : '' }}" name="retention" value="0">
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        <label>Others</label>
                                        <input type="number" step="any" class="form-control {{ $errors->has('others') ? ' is-invalid' : '' }}" name="others" value="0">
                        ...
                        <form id="information-invoice-form" method="POST" action="{{ route('facturasproveedor.modificar') }}" enctype="multipart/form-data" class="pl-2 pr-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        <label>Neto <span class="text-danger">*</span></label>
                                        <input type="number" step="any" class="form-control {{ $errors->has('neto') ? ' is-invalid' : '' }}" name="neto">
                                        @if ($errors->has('neto'))
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $errors->first('neto') }}</strong>
                                            </span>
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="any" class="form-control {{ $errors->has('vat') ? ' is-invalid' : '' }}" name="vat">
                                        @if ($errors->has('vat'))
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $errors->first('vat') }}</strong>
                                            </span>
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="any" class="form-control {{ $errors->has('retention') ? ' is-invalid' : '' }}" name="retention">
                                        @if ($errors->has('retention'))
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $errors->first('retention') }}</strong>
                                            </span>
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="any" class="form-control {{ $errors->has('others') ? ' is-invalid' : '' }}" name="others">
                                        @if ($errors->has('others'))
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $errors->first('others') }}</strong>
                                            </span>
                ...
                <div class="modal-content">
                    <div class="modal-body p-4">
                        <div class="text-center">
                            ...
                            <h4 class="mt-2">Precaución!</h4>
                            <p class="mt-3">¿Está seguro(a) de autorizar esta factura?</p>
                            <button type="button" class="btn btn-light my-2" data-dismiss="modal">Cancelar</button>
