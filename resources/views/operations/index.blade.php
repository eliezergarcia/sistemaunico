            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive-sm">
                        <table id="operations-datatable" class="table table-centered table-striped dt-responsive table-hover table-striped table-striped nowrap w-100 dataTable no-footer dtr-inline">
                            <thead>
                                <tr>
                                    <th width="4%">#</th>
