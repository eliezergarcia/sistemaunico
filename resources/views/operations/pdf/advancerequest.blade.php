            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Solicitud de anticipo</li>
                    </ol>
                </div>
                <h4 class="page-title">Solicitud de anticipo {{ $invoice->controlcode }}</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                ...
                <div class="card-body">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-3 row justify-content-center align-items-center">
                            <div class="">
                                <h3>&nbsp;SOL. ANTICIPO<br><h2>( {{ $invoice->controlcode }} )<h2></h3>
                            </div>
                        </div>
                    </div>
                    <br>
