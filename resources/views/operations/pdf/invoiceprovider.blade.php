...
@section('title', 'FACT. PROV. - '.$invoice->controlcode)
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Factura de proveedor {{ $invoice->factura }}</li>
                    </ol>
                </div>
                <h4 class="page-title">Factura de proveedor {{ $invoice->factura }}</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-8">
                                    <h5 style="margin: 10px;">
                                        ...
                                        {{ $invoice->operation->debitnotes->isEmpty() && $invoice->operation->prefactures->isEmpty() ? 'PENDING' : $invoice->facturasUnico() }}
                                    </h5>
                                </div>
                            </div>
                        </div>
