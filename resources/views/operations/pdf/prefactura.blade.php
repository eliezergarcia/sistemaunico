                            ...
                            <div id="container-nodes" class="row">
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control {{ $errors->has('neto') ? ' is-invalid' : '' }}" type="number" step="any" name="neto" value="{{ $prefacture->ratetotal }}" onchange="calcularTotal()">
                                        @if ($errors->has('neto'))
                                            <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control {{ $errors->has('iva') ? ' is-invalid' : '' }}" type="number" step="any" name="iva" value="{{ $prefacture->ivatotal }}" onchange="calcularTotal()">
                                        @if ($errors->has('iva'))
                                            <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        <label>Total</label>
                                        <input class="form-control " type="number" step="any" id="total" value="{{ $prefacture->ratetotal + $prefacture->ivatotal }}">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
